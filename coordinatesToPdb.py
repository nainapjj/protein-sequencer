...
GENERATED_PDB_FILE = "data/GeneratedFromInitial-NewWith1D.pdb"
...
def generatePdbFileFromAminoSeqWithIndex(coordinateSeq, usedAmino, aminoSeqWithIndexDict):
    ...
    for caCoord in coordinateSeq:
        ...
        #             ATOM   Atom #  Atm Na Res Name ChainId Res #  X Coord Y Coord Z Coord
        pdbString += "ATOM  {0:5d}  {1:2s}  {2:3s} {3:1s}{4:4d}    {5:8.3f}{6:8.3f}{7:8.3f}\n".format(currentAtom, 
                     "CA", aminoSeqWithIndexDict[usedAmino[currentCount]], "A", usedAmino[currentCount], caCoord[0], caCoord[1], caCoord[2])
        currentCount += 1
